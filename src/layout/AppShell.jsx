...
export function AppShell({ pageProps }) {
  return (
    <main className="mx-auto flex min-h-screen max-w-5xl flex-col px-4 pb-20 pt-4 sm:px-6 lg:px-8">
      ...
      <nav className="fixed inset-x-0 bottom-0 border-t border-white/70 bg-panel/95 px-3 pb-[max(env(safe-area-inset-bottom),0.75rem)] pt-2 shadow-card backdrop-blur">
